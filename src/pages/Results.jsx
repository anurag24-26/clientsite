...
const toppers = [
  { name: "Shreya", class: "12 CBSE", marks: "95%" },
  { name: "Shewta", class: "12 CBSE", marks: "94%" },
  { name: "Ankit Chand", class: "12 CBSE", marks: "93%" },
];
          ...
          <table className="w-full text-left table-auto">
            ...
            <tbody className="text-gray-700">
              <tr className="border-b">
                <td className="py-2 px-4">Riya Sharma</td>
                <td className="py-2 px-4">10 CBSE</td>
                <td className="py-2 px-4">92%</td>
              </tr>
              <tr className="border-b">
                <td className="py-2 px-4">Amit Verma</td>
                <td className="py-2 px-4">12 UP</td>
                <td className="py-2 px-4">85%</td>
              </tr>
              <tr className="border-b">
                <td className="py-2 px-4">Anjali Singh</td>
                <td className="py-2 px-4">12 CBSE</td>
